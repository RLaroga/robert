...
public class Main {
    public static void main (String [] args) {
         ...
         *                    when elements are frequently accessed by their index. {@link Array}
         *
         *      - LinkedList : Implements List using a doubly-linked list. It is efficient for frequent insertions
         *                     and deletions at the beginning, end, or middle of the list. {@link Linked}
         *
         *      - Vector : Similar to ArrayList, but it is synchronized (thread-safe). It is less commonly used
         *                 nowadays, and ArrayList is generally preferred in most scenarios. {@link Vetor}
         *
         ...
         *                                  (ArrayDeque or LinkedList) to work as a stack. {@link Stack}
         *
         */
